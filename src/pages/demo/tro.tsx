...
const TROApp = dynamic(
  () => import('../../components/AllDashboards').then(m => m.TROApp),
  { ssr: false, loading: () => (
...
export default function DemoTRO() {
  return (
    <>
      <Head>
        <title>Demo TRO Security — SOMA BMS</title>
      ...
      <TROApp onBack={() => { window.location.href = '/' }} />
    </>
  )
}
